    ...
    <section className="bg-white py-14 md:py-24" onClick={handleBackgroundClick}>
      <div className="container mx-auto">
        ...
        <div className="prose mx-auto mb-10">
          ...
          <h1 className='font-bold text-primary text-2xl hover:text-secondary'> Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quasi, dignissimos.</h1>
          <p className="text-base md:text-lg">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quasi quo debitis quaerat tempora in laboriosam est nulla ratione voluptatibus voluptatum nihil voluptates culpa eius magnam eaque similique quam dignissimos ullam vitae, nisi consequatur enim! Reiciendis doloremque maiores nostrum error suscipit ullam totam dolorem magni, nam blanditiis mollitia atque ducimus impedit animi amet corporis asperiores itaque placeat. Neque repellendus itaque numquam alias nihil architecto mollitia possimus nostrum qui eaque labore, asperiores quis totam maiores accusamus impedit aliquid voluptatum autem similique iste quisquam tempore eligendi quos officiis! Eveniet vel ipsa atque aperiam!</p>
        </div>
