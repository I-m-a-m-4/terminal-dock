...
const Home = () => {
  useEffect(() => {
    // UnicornStudio is loaded via index.html script tag ΓÇö just initialise it
          ...
          <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden">
            <div className="container mx-auto px-6 text-center flex flex-col items-center">
              ...
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-zinc-800 bg-zinc-900/50 text-xs text-zinc-400 mb-8 backdrop-blur-sm">
                ...
                Now in public beta ΓÇö free to try
              </div>
              ...
              <p className="text-lg md:text-xl text-zinc-400 max-w-2xl mb-10 font-light">
                TerminalDock gives developers a beautifully organized, persistent workspace for their terminals ΓÇö tabs, sessions, and commands all in one dock.
              </p>
              ...
              <div className="relative max-w-4xl mx-auto">
                ...
                <div className="relative rounded-2xl border border-zinc-800 overflow-hidden shadow-2xl bg-zinc-950/50 backdrop-blur-sm">
                  ...
                  <div className="flex items-center gap-1.5 px-4 py-3 border-b border-zinc-800 bg-zinc-950/80">
                    ...
                    <span className="w-3 h-3 rounded-full bg-zinc-700"></span>
                    <span className="w-3 h-3 rounded-full bg-zinc-700"></span>
                    <span className="ml-4 text-xs text-zinc-500 font-mono">terminal-dock ΓÇö trailer.mp4</span>
                  </div>
                ...
                <p className="text-center text-xs text-zinc-600 mt-4 font-mono">
                  TerminalDock v1.0 ΓÇö Official Trailer
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="py-20 border-y border-zinc-900 bg-zinc-950/50">
            <div className="container mx-auto px-6">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8 divide-x divide-zinc-900">
                ...
                <div className="flex flex-col items-center text-center px-4">
                  <span className="text-4xl font-medium tracking-tight text-zinc-100 mb-2">4.9Γÿà</span>
          ...
          <section className="py-24 md:py-32" id="features">
            <div className="container mx-auto px-6">
              <div className="max-w-3xl mb-16">
                ...
                <p className="text-lg text-zinc-400">Every feature is designed to keep you in flow ΓÇö less context switching, more shipping.</p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="group p-8 rounded-2xl border border-zinc-900 bg-zinc-950 hover:bg-zinc-900/50 transition-all duration-300">
                  ...
                  <p className="text-sm text-zinc-400 leading-relaxed mb-6">
                    Never lose your terminal sessions again. Dock them, name them, and resume exactly where you left off ΓÇö even after a reboot.
                  </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="group relative overflow-hidden rounded-2xl border border-zinc-900 bg-zinc-950 aspect-[4/3] flex flex-col justify-between p-8 hover:border-zinc-700 transition-colors">
                  ...
                  <div className="relative z-10">
                    <div className="text-4xl font-medium tracking-tight text-emerald-400 mb-2">3├ù faster</div>
                ...
                <div className="group relative overflow-hidden rounded-2xl border border-zinc-900 bg-zinc-950 aspect-[4/3] flex flex-col justify-between p-8 hover:border-zinc-700 transition-colors">
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-sm text-zinc-400">Managing 6 client projects simultaneously with zero confusion ΓÇö each with its own persistent dock.</p>
                  </div>
                </div>
                ...
                <div className="group relative overflow-hidden rounded-2xl border border-zinc-900 bg-zinc-950 aspect-[4/3] flex flex-col justify-between p-8 hover:border-zinc-700 transition-colors">
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-sm text-zinc-400">Automated recurring server commands with scripted docks ΓÇö no more manual SSH juggling.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="container mx-auto px-6 relative z-10">
              <div className="max-w-4xl mx-auto rounded-3xl border border-zinc-800 bg-zinc-950/80 backdrop-blur-xl p-8 md:p-12 shadow-2xl flex flex-col md:flex-row gap-12">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-zinc-400 mb-8">Join thousands of developers who've upgraded their terminal workflow. Tell us about your setup ΓÇö we'll help you get started fast.</p>

                  <div className="space-y-4 text-sm text-zinc-300">
                    <div className="flex items-start gap-3">
                      <iconify-icon icon="solar:check-circle-linear" className="text-zinc-500 mt-0.5 text-base"></iconify-icon>
                      <span>Free tier available ΓÇö no credit card required</span>
                    </div>
                    <div className="flex items-start gap-3">
                      <iconify-icon icon="solar:check-circle-linear" className="text-zinc-500 mt-0.5 text-base"></iconify-icon>
